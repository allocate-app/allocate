...
class Tiles {
  ...
  static Widget toDoCheckTile({
    ...
    return ListTile(
        ...
        leading: Checkbox(
            ...
            onChanged: (bool? value) {
              onChanged(index: index, value: value!);
            }),
    ...
    return Padding(
      ...
      child: ListTile(
        ...
        trailing: (expectedDuration > 0)
            ...
            : const SizedBox.shrink(),
        // TODO: Could be refactored into a helper method.
  ...
  static Future<void> innerDateTimeDialog({
    DateTime? date,
    TimeOfDay? time,
    required BuildContext context,
    String dialogHeader = "",
  ...
  // This is not ideal and fairly coupled. TODO: Figure out how to organize.
      ...
      child: ListTile(
          ...
          title: (frequency == Frequency.once)
              ...
              : AutoSizeText(toBeginningOfSentenceCase(frequency.name)!,
                  ...
                  maxLines: 1,
                  softWrap: false),
          // TODO: Consider refactoring into a helper dialog
          onTap: () async {
            await showDialog(
                context: context,
                builder: (BuildContext context) {
