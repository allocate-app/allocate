...
class _CreateToDoScreen extends State<CreateToDoScreen> {
  ...
  Dialog buildDesktopDialog(
      BuildContext context, bool smallScreen, Color errorColor) {
    return Dialog(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.symmetric(
                          horizontal: Constants.padding),
                      child:
                          buildDurationTile(context, smallScreen: smallScreen),
                    ),
  ...
  ReorderableListView buildReorderableSubTasks(
    ...
    return ReorderableListView.builder(
      physics: NeverScrollableScrollPhysics(parent: physics),
      shrinkWrap: true,
